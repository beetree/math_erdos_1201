...
public import Erdos1201.Vendor.NumberTheory.BoundedPrimeGaps.BombieriVinogradov.Analytic.DirichletPerronOneTerm
...
private lemma summable_perron_nearMass
  ...
  rw [dirichletPerronNearError, ite_eq_right]
  · simp
  · intro h
...
private lemma ratio_mass_identity
  ...
  rw [LSeries.norm_term_eq, ite_eq_right hn.ne', Complex.ofReal_re,
