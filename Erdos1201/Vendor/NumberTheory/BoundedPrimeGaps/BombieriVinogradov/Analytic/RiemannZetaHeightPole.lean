...
public import Erdos1201.Vendor.NumberTheory.BoundedPrimeGaps.BombieriVinogradov.Analytic.DirichletLZeroDivisor
public import Erdos1201.Vendor.NumberTheory.BoundedPrimeGaps.BombieriVinogradov.Analytic.FixedDiskLogDerivative
public import Erdos1201.Vendor.NumberTheory.BoundedPrimeGaps.BombieriVinogradov.Analytic.RiemannZetaRadiusFour
...
private lemma divisor_riemannZeta₁_radiusTwo_apply
  ...
  · rw [ite_eq_left hrho, MeromorphicOn.AnalyticOnNhd.divisor_apply
      ((differentiable_riemannZeta₁.differentiableOn.analyticOnNhd isOpen_univ).mono
        (Set.subset_univ (closedBall ((2 : ℂ) + t * I) 2)))
      (mem_closedBall.mpr hrho)]
    have hfinite := analyticOrderAt_riemannZeta₁_ne_top rho
    rw [← Nat.cast_analyticOrderNatAt hfinite, ENat.map_natCast,
      WithTop.untop₀_coe]
  · rw [ite_eq_right hrho,
