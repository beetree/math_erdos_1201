...
public import Erdos1201.Vendor.NumberTheory.BoundedPrimeGaps.BombieriVinogradov.Analytic.BilinearLargeSieve
public import Erdos1201.Vendor.NumberTheory.BoundedPrimeGaps.BombieriVinogradov.Analytic.BilinearPerronAggregate
public import Erdos1201.Vendor.NumberTheory.BoundedPrimeGaps.BombieriVinogradov.Analytic.PerronEnvelopeIntegral
...
theorem sum_weighted_norm_bilinear_natLogTwists_subset_Ioc_le
  ...
  have hnorm (n : ℕ) : ‖natLogTwist n t‖ = 1 := by
    unfold natLogTwist
  ...
  simpa only [norm_mul, hnorm, mul_one] using
