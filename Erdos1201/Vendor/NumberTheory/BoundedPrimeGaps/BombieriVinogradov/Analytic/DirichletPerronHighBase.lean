...
public import Erdos1201.Vendor.NumberTheory.BoundedPrimeGaps.BombieriVinogradov.Analytic.DirichletPerronLowBase
public import Erdos1201.Vendor.NumberTheory.BoundedPrimeGaps.BombieriVinogradov.Analytic.RectangleReciprocalWedgeIntegral
...
noncomputable def dirichletPerronHighQuotient
    (y : ℝ) (s : ℂ) : ℂ :=
  (y : ℂ) ^ s / s
