...
public import Erdos1201.Vendor.NumberTheory.BoundedPrimeGaps.BombieriVinogradov.Analytic.AdditiveLargeSieve.ReducedFractionLargeSieve
public import Erdos1201.Vendor.NumberTheory.BoundedPrimeGaps.BombieriVinogradov.Analytic.PrimitiveCharacterAdditiveReduction
...
private theorem sum_positiveModuliUpTo_eq_sum_Ioc
  ...
  calc
    ...
    _ = ∑ q ∈ Finset.Ioc 0 Q, f q := by
      simpa using congrArg (fun s : Finset ℕ => ∑ q ∈ s, f q)
        (Finset.Icc_succ_left_eq_Ioc 0 Q)
