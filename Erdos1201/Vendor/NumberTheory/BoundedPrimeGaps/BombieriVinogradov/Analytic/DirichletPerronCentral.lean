...
public import Erdos1201.Vendor.NumberTheory.BoundedPrimeGaps.BombieriVinogradov.Analytic.DirichletExplicitFormulaKernel
public import Erdos1201.Vendor.NumberTheory.BoundedPrimeGaps.BombieriVinogradov.Analytic.DirichletPerronKernel
public import Erdos1201.Vendor.NumberTheory.BoundedPrimeGaps.BombieriVinogradov.Analytic.DirichletSineRemainder
...
private lemma norm_dirichletExplicitFormulaKernel_horizontal_le__DirichletPerronCentral
    ...
    calc
      ‖∫ r in (0 : ℝ)..alpha,
        ...
        intervalIntegral.norm_integral_le_of_norm_le_const (by
          ...
          exact norm_dirichletExplicitFormulaKernel_horizontal_le__DirichletPerronCentral
    ...
    calc
      ‖∫ r in (0 : ℝ)..alpha,
        ...
        intervalIntegral.norm_integral_le_of_norm_le_const (by
          ...
          rw [uIoc_of_le halpha.le] at hr
          have hbound :=
            norm_dirichletExplicitFormulaKernel_horizontal_le__DirichletPerronCentral
