...
public import Erdos1201.Vendor.NumberTheory.BoundedPrimeGaps.BombieriVinogradov.Analytic.DirichletPerronCentralNatural
public import Erdos1201.Vendor.NumberTheory.BoundedPrimeGaps.BombieriVinogradov.Analytic.DirichletPerronHighBase
    ...
    · by_cases hUpper : (n : ℝ) < 2 * x
      · have hcentral :=
        ...
        rw [dirichletPerronNearError,
          ite_eq_left ⟨hn, hLower, hUpper, hne⟩]
      ...
      · have hOuter :
        ...
        rw [dirichletPerronNearError, ite_eq_right (by
          intro h
