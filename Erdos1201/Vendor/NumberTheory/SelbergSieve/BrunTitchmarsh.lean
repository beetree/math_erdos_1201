...
Vendored proof excerpt through `primesBetween_le`, adapted to local module paths.
-/
...
public import Erdos1201.Vendor.NumberTheory.SelbergSieve.Selberg
public import Erdos1201.Vendor.NumberTheory.SelbergSieve.Bounds
@[expose] public section

open Sieve Sieve.P520 SelbergSieve SelbergSieve.P520 BoundingSieve
...
theorem boudingSum_ge : SelbergSieve.P520.selbergBoundingSum (primeInterSieve x y z hz) ≥ Real.log z / 2 := by
...
theorem siftedSum_le (hz : 1 < z) :
  ...
  apply le_trans (SelbergSieve.P520.selberg_bound_simple ..)
